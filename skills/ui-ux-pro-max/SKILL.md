...
This skill is the flagship of the `ui-ux-pro-max` plugin. Six companion skills from
the same source are bundled under `plugin-skills/` as reference material (not
auto-discovered as separate skills). Read the relevant one on demand:

- `plugin-skills/brand/` — brand systems, voice, logo/color/typography rules.
- `plugin-skills/design-system/` — tokens, slide/layout logic, component data.
- `plugin-skills/ui-styling/` — deep styling reference library.
- `plugin-skills/design/` — general design guidance.
- `plugin-skills/banner-design/` — banner sizes and styles.
- `plugin-skills/slides/` — presentation/slide design.
